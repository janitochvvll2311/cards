...
class GraphComponent extends WebComponent {
    ...
    update() {
        if (this.#binding) {
            ...
            this.#binding.attack.innerText = this.#attack;
            this.#binding.defense.innerText = this.#defense;
            this.#binding.speed.innerText = this.#speed;
            this.#binding.magic.innerText = this.#magic;
